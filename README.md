...
#### Step7: Authenticate users from a Windows client  
#### Step8: Perform common AD tasks via GUI and PowerShell  
#### Step9: Troubleshoot basic Active Directory issues  
...
Steps to Connect to Azure VM via RDP
